...
class DatabaseManager
{
     ...
     */
    public static function read(string $name = 'default', string $sql, array $params = []): array
    {
     ...
     */
    public static function write(string $name = 'default', string $sql, array $params = []): bool
    {
