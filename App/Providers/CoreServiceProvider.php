...
use App\Core\Health\Checks\DatabaseHealthCheck;
use App\Core\Health\Checks\CacheHealthCheck;
use App\Core\Health\Checks\DiskSpaceHealthCheck;
use App\Core\Health\Checks\PhpVersionHealthCheck;
...
class CoreServiceProvider implements ServiceProviderInterface
{
    public function register(Container $app): void
    {
        ...
        $app->singleton(HealthService::class, function ($app) {
            ...
            $health->registerCheck(new DatabaseHealthCheck($app->resolve(\PDO::class)));
